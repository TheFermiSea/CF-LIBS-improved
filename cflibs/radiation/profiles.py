...
if HAS_JAX:
    ...
    # Keep coefficients as Python data so importing this module does not
    # force JAX array materialization or backend initialization.
    _WEIDEMAN_COEFFS_RAW = (
    ...
    def _faddeeva_weideman_jax(z: jnp.ndarray) -> jnp.ndarray:
        ...
        """
        coeffs = jnp.asarray(_WEIDEMAN_COEFFS_RAW, dtype=_weideman_dtype)
        L = _WEIDEMAN_L
