...
```bash
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local frontmatter validate .gpd/phases/XX-name/XX-YY-PLAN.md --schema plan
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local validate plan-contract .gpd/phases/XX-name/XX-YY-PLAN.md
```
