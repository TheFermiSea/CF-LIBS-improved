...
```bash
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local frontmatter validate .gpd/phases/XX-name/XX-YY-SUMMARY.md --schema summary
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local validate summary-contract .gpd/phases/XX-name/XX-YY-SUMMARY.md
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local frontmatter validate .gpd/phases/XX-name/XX-VERIFICATION.md --schema verification
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local validate verification-contract .gpd/phases/XX-name/XX-VERIFICATION.md
```
