...
Before authoring or revising the `contract:` block, use `@./.claude/get-physics-done/templates/plan-contract-schema.md` as the schema source of truth. The contract must stay a YAML object with object arrays and fully resolved ID cross-links.
