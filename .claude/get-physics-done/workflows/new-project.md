...
```bash
printf '%s\n' "$PROJECT_CONTRACT_JSON" | /home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local --raw validate project-contract -
```
...
```bash
printf '%s\n' "$PROJECT_CONTRACT_JSON" | /home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local state set-project-contract -
```
...
PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/PROJECT.md .gpd/REQUIREMENTS.md .gpd/ROADMAP.md .gpd/STATE.md .gpd/state.json .gpd/config.json 2>&1) || true
echo "$PRE_CHECK"

/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "docs: initialize research project (minimal)" --files .gpd/PROJECT.md .gpd/REQUIREMENTS.md .gpd/ROADMAP.md .gpd/STATE.md .gpd/state.json .gpd/config.json
```
...
```bash
INIT=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local init new-project)
if [ $? -ne 0 ]; then
...
Consult `./.claude/get-physics-done/references/research/questioning.md` for techniques:
...
As you go, mentally check the context checklist from `./.claude/get-physics-done/references/research/questioning.md`. If gaps remain, weave questions naturally. Don't suddenly switch to checklist mode.
...
When you could write a clear scoping contract, use AskUserQuestion:
...
PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/PROJECT.md .gpd/state.json 2>&1) || true
echo "$PRE_CHECK"

/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "docs: initialize research project" --files .gpd/PROJECT.md .gpd/state.json
```
...
```bash
PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/config.json 2>&1) || true
echo "$PRE_CHECK"

/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "chore: add project config" --files .gpd/config.json
```
...
```
Task(prompt="First, read ./.claude/agents/gpd-project-researcher.md for your role and instructions.
...
Use template: ./.claude/get-physics-done/templates/research-project/PRIOR-WORK.md
</output>
...
Use template: ./.claude/get-physics-done/templates/research-project/METHODS.md
</output>
...
Use template: ./.claude/get-physics-done/templates/research-project/COMPUTATIONAL.md
</output>
...
Use template: ./.claude/get-physics-done/templates/research-project/PITFALLS.md
</output>
...
```
Task(prompt="First, read ./.claude/agents/gpd-research-synthesizer.md for your role and instructions.
...
Use template: ./.claude/get-physics-done/templates/research-project/SUMMARY.md
...
```bash
PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/research/PRIOR-WORK.md .gpd/research/METHODS.md .gpd/research/COMPUTATIONAL.md .gpd/research/PITFALLS.md .gpd/research/SUMMARY.md 2>&1) || true
echo "$PRE_CHECK"

/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "docs: literature survey complete" \
...
```bash
PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/REQUIREMENTS.md 2>&1) || true
echo "$PRE_CHECK"

/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "docs: define research requirements" --files .gpd/REQUIREMENTS.md
```
...
```
Task(prompt="First, read ./.claude/agents/gpd-roadmapper.md for your role and instructions.
...
```bash
PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/ROADMAP.md .gpd/STATE.md .gpd/REQUIREMENTS.md 2>&1) || true
echo "$PRE_CHECK"

/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "docs: create research roadmap ([N] phases)" --files .gpd/ROADMAP.md .gpd/STATE.md .gpd/REQUIREMENTS.md
```
...
```
Task(prompt="First, read ./.claude/agents/gpd-notation-coordinator.md for your role and instructions.
...
2. **Populate the convention_lock** with at minimum the unit system and metric signature:
   ...
   /home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention set natural_units "natural" 2>/dev/null || true
   /home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention set metric_signature "mostly_minus" 2>/dev/null || true
   ```

   Adjust values based on what PROJECT.md specifies. If PROJECT.md doesn't specify conventions, use the subfield defaults from `./.claude/get-physics-done/references/conventions/subfield-convention-defaults.md`.
...
- **`CONVENTIONS ESTABLISHED`:** Display confirmation with convention summary. Commit CONVENTIONS.md:
  ...
  ```bash
  PRE_CHECK=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pre-commit-check --files .gpd/CONVENTIONS.md 2>&1) || true
  echo "$PRE_CHECK"

  /home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local commit "docs: establish notation conventions" --files .gpd/CONVENTIONS.md
  ```
