...
> **Platform note:** If `AskUserQuestion` is not available, ask the same missing questions inline in one compact batch and wait for the user's freeform response.
</step>
...
- `./.claude/get-physics-done/templates/slides/presentation-brief.md`
- `./.claude/get-physics-done/templates/slides/outline.md`
- `./.claude/get-physics-done/templates/slides/slides.md`
- `./.claude/get-physics-done/templates/slides/speaker-notes.md`
- `./.claude/get-physics-done/templates/slides/main.tex`
</step>
