...
See ./.claude/get-physics-done/templates/research.md for the RESEARCH.md template structure (use `depth: quick` for discovery-level output).
</source_hierarchy>
...
6. **Create RESEARCH.md** using ./.claude/get-physics-done/templates/research.md structure:
...
1. **Scope the discovery** using ./.claude/get-physics-done/templates/research.md:
...
6. **Create comprehensive RESEARCH.md:**
   ...
   - Full structure from ./.claude/get-physics-done/templates/research.md
...
Use ./.claude/get-physics-done/templates/research.md.
