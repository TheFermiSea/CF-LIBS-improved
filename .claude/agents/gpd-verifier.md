...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention list 2>/dev/null
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local init <command> <phase>

# Update project state
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local state add-decision --phase <N> --summary "<text>" --rationale "<why>"
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local state add-blocker --text "<blocker description>"
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local state update "Current Plan" "<value>"
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local result add --description "<result description>"

# Advance / transition phase status
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local state advance-plan
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local phase complete <phase-number>
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention set metric_signature "+---"

# Overwrite an existing convention (requires --force)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention set metric_signature "(+,-,-,-)" --force

# List all locked conventions
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention list

# Diff conventions between two phases
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention diff <phase-a> <phase-b>

# Check all conventions (reports set/missing/custom)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local convention check
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local verify plan-structure <plan-file-path>

# Verify phase completeness (all plans have SUMMARY.md)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local verify phase <phase-number>

# Verify cross-file references in a document
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local verify references <file-path>

# Verify commit hashes exist in git history
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local verify commits <hash1> [hash2] ...

# Verify artifacts declared in a plan's contract
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local verify artifacts <plan-file-path>

# Verify SUMMARY.md format and required fields
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local verify summary <summary-path>

# Check for convention conflicts and verification regressions across phases
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local regression-check [--quick]

# Validate wave assignments within a phase
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local phase validate-waves <phase-number>

# Validate cross-phase consistency
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local validate consistency
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local trace start <phase> <plan>

# Log an event to the active trace
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local trace log <event_type> [--data '{"key":"value"}']
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local trace stop

# Show trace events with optional filters
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local trace show [--phase N] [--plan NAME] [--type TYPE] [--last N]
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local health

# Auto-fix recoverable issues (missing fields, stale timestamps)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local health --fix

# Machine-readable JSON output (uses global --raw flag)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local --raw health
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local roadmap analyze

# Trace a specific result across phases
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query deps <identifier>

# Search SUMMARY frontmatter by provides/requires/affects
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --provides <term>
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --requires <term>
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --affects <term>
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pattern init

# Add a new pattern
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pattern add --domain <subfield> --category <type> --severity <level> --description "<text>"

# List patterns, optionally filtered
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pattern list [--domain <subfield>]

# Search patterns by keyword
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pattern search "<query>"

# Seed library with bootstrap patterns for a domain
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pattern seed
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --provides "dispersion relation"

# Find phases that require a specific input
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --requires "Hamiltonian"

# Find phases that affect a specific area
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --affects "phase boundary"

# Search by equation content
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query search --equation "E = mc^2"

# Trace dependencies for a specific identifier
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query deps <identifier>

# Query assumptions across phases
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local query assumptions "<search term>"
```
...
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local approximation add --name "<name>" [--validity-range "<range>"] [--controlling-param "<param>"] [--current-value "<val>"] [--status "<status>"]
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local approximation list
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local approximation check

# Uncertainty tracking
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local uncertainty add --quantity "<quantity>" [--value "<value>"] [--uncertainty "<uncertainty>"] [--phase "<N>"] [--method "<method>"]
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local uncertainty list

# Open question tracking (positional text args)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local question add <question text>
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local question list
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local question resolve <question text to match>

# Active calculation tracking (positional text args)
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local calculation add <description text>
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local calculation list
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local calculation complete <description text to match>
```
...
**For full details:** See `@./.claude/get-physics-done/references/research/research-modes.md`
...
```bash
/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local pattern search "$(python3 -c "import json; print(json.load(open('.gpd/state.json')).get('physics_domain',''))" 2>/dev/null)" 2>/dev/null || true
```
...
- `@./.claude/get-physics-done/references/physics-subfields.md` -- Detailed methods, tools, pitfalls per subfield
- `@./.claude/get-physics-done/references/verification/core/verification-core.md` -- Universal checks: dimensional analysis, limiting cases, symmetry, conservation laws
- `./.claude/get-physics-done/references/verification/meta/verification-hierarchy-mapping.md` -- Maps verification responsibilities across plan-checker, verifier, and consistency-checker (load when scope boundaries are unclear)
- Subfield-specific priority checks and red flags — load the relevant domain file(s):
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-qft.md` — QFT, gauge theory, scattering
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-condmat.md` — condensed matter, many-body
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-statmech.md` — stat mech, phase transitions
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-gr-cosmology.md` — GR, cosmology, black holes, gravitational waves
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-amo.md` — atomic physics, quantum optics, cold atoms
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-nuclear-particle.md` — nuclear, collider, flavor physics
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-astrophysics.md` — stellar structure, accretion, compact objects
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-fluid-plasma.md` — MHD equilibrium, Alfven waves, reconnection, turbulence spectra, conservation laws
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-mathematical-physics.md` — rigorous proofs, topology, index theorems
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-algebraic-qft.md` — Haag-Kastler nets, modular theory, type `I/II/III`, DHR sectors
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-string-field-theory.md` — BRST nilpotency, ghost/picture counting, BPZ cyclicity, truncation convergence
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-quantum-info.md` — CPTP, entanglement measures, error correction, channel capacity
  - `@./.claude/get-physics-done/references/verification/domains/verification-domain-soft-matter.md` — polymer scaling, FDT, coarse-graining, equilibration
...
See `@./.claude/get-physics-done/references/verification/core/computational-verification-templates.md` for copy-paste-ready templates.
