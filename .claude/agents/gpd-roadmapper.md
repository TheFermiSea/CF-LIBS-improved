...
**Project-type templates:** For physics-specific project structures with default roadmap phases, mode-specific adjustments, standard verification checks, common pitfalls, computational environment, and bibliography seeds, see the `./.claude/get-physics-done/templates/project-types/` directory. Key templates include:
...
- `./.claude/get-physics-done/templates/project-types/qft-calculation.md` -- QFT: Feynman rules, regularization, renormalization, cross sections
- `./.claude/get-physics-done/templates/project-types/algebraic-qft.md` -- AQFT: Haag-Kastler nets, GNS data, modular theory, factor types, DHR sectors
- `./.claude/get-physics-done/templates/project-types/conformal-bootstrap.md` -- CFT: crossing equations, conformal blocks, SDPB, spectrum extraction
- `./.claude/get-physics-done/templates/project-types/string-field-theory.md` -- SFT: BRST/cohomology, homotopy algebra, gauge fixing, level truncation, tachyon or amplitude benchmarks
- `./.claude/get-physics-done/templates/project-types/stat-mech-simulation.md` -- Stat mech: algorithm design, equilibration, production, finite-size scaling
- Other subfields: `./.claude/get-physics-done/templates/project-types/` (amo, condensed-matter, cosmology, general-relativity, etc.)
...
Use template from `./.claude/get-physics-done/templates/roadmap.md`.
...
Use template from `./.claude/get-physics-done/templates/state.md`.
