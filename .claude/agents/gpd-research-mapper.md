...
- `@./.claude/get-physics-done/references/physics-subfields.md` -- Methods, tools, and validation strategies per physics subfield (informs framework and formalism analysis)
...
- `@./.claude/get-physics-done/references/templates/research-mapper/FORMALISM.md`
- `@./.claude/get-physics-done/references/templates/research-mapper/REFERENCES.md`

**Computation focus** (ARCHITECTURE.md, STRUCTURE.md):
- `@./.claude/get-physics-done/references/templates/research-mapper/ARCHITECTURE.md`
- `@./.claude/get-physics-done/references/templates/research-mapper/STRUCTURE.md`

**Methodology focus** (CONVENTIONS.md, VALIDATION.md):
- `@./.claude/get-physics-done/references/templates/research-mapper/CONVENTIONS.md`
- `@./.claude/get-physics-done/references/templates/research-mapper/VALIDATION.md`

**Status focus** (CONCERNS.md):
- `@./.claude/get-physics-done/references/templates/research-mapper/CONCERNS.md`

### When Template Files Don't Exist

If a template file is not found at the expected path (e.g., `./.claude/get-physics-done/references/templates/research-mapper/` does not exist), treat that as a broken install and fall back to this procedure:

1. **Do not search alternate runtime-specific paths.** GPD installs the shared reference tree at a deterministic `./.claude/get-physics-done` location for every runtime.
...
<!-- 843 lines of inline templates removed — now loaded from reference files above.
     See ./.claude/get-physics-done/references/templates/research-mapper/ for the full templates.
