...
<execution_context>
@./.claude/get-physics-done/workflows/execute-phase.md
...
Read the file at ./.claude/get-physics-done/workflows/execute-phase.md — this contains the complete step-by-step instructions. Do NOT improvise. Follow the workflow file exactly.
