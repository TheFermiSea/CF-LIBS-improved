...
<execution_context>
@./.claude/get-physics-done/workflows/verify-work.md
...
@./.claude/get-physics-done/templates/contract-results-schema.md
</execution_context>
...
Read the file at ./.claude/get-physics-done/workflows/verify-work.md — this contains the complete step-by-step instructions. Do NOT improvise. Follow the workflow file exactly.
