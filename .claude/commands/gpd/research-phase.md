...
<execution_context>
@./.claude/get-physics-done/workflows/research-phase.md
...
```bash
INIT=$(/home/brian/.gpd/venv/bin/python -m gpd.runtime_cli --runtime claude-code --config-dir ./.claude --install-scope local init phase-op "$ARGUMENTS")
```
