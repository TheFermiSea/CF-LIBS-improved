...
<execution_context>
@./.claude/get-physics-done/workflows/write-paper.md
@./.claude/get-physics-done/templates/paper/paper-config-schema.md
</execution_context>
...
<process>
**Follow the write-paper workflow** from `@./.claude/get-physics-done/workflows/write-paper.md`.
...
7. **Generate files** — Create `paper/PAPER-CONFIG.json` using `@./.claude/get-physics-done/templates/paper/paper-config-schema.md`, then materialize the canonical manuscript scaffold with `gpd paper-build` (emits `paper/main.tex`, bibliography artifacts, and `paper/ARTIFACT-MANIFEST.json`)
