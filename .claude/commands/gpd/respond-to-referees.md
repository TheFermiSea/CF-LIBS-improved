...
<execution_context>
@./.claude/get-physics-done/workflows/respond-to-referees.md
</execution_context>
...
<process>
Execute the respond-to-referees workflow from @./.claude/get-physics-done/workflows/respond-to-referees.md end-to-end.
