...
<execution_context>
@./.claude/get-physics-done/workflows/validate-conventions.md
</execution_context>
...
<process>
Execute the validate-conventions workflow from @./.claude/get-physics-done/workflows/validate-conventions.md end-to-end.
