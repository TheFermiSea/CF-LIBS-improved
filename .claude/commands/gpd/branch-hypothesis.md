...
<execution_context>
@./.claude/get-physics-done/workflows/branch-hypothesis.md
</execution_context>
...
<process>
Execute the branch-hypothesis workflow from @./.claude/get-physics-done/workflows/branch-hypothesis.md end-to-end.
