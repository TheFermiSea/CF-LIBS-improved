...
<execution_context>
@./.claude/get-physics-done/workflows/compare-branches.md
</execution_context>
...
<process>
Execute the compare-branches workflow from @./.claude/get-physics-done/workflows/compare-branches.md end-to-end.
