...
<execution_context>
@./.claude/get-physics-done/workflows/progress.md
</execution_context>
...
Read the file at ./.claude/get-physics-done/workflows/progress.md — this contains the complete step-by-step instructions. Do NOT improvise. Follow the workflow file exactly.
