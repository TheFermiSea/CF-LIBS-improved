...
<execution_context>
@./.claude/get-physics-done/workflows/regression-check.md
</execution_context>
...
<process>
Execute the regression-check workflow from @./.claude/get-physics-done/workflows/regression-check.md end-to-end.
