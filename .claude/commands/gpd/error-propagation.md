...
<execution_context>
@./.claude/get-physics-done/workflows/error-propagation.md
</execution_context>
...
<process>
Execute the error-propagation workflow from @./.claude/get-physics-done/workflows/error-propagation.md end-to-end.
