...
module map, see [Codebase Architecture](../reference/Codebase_Architecture.md#element-identification-architecture).
...
[Physics: Equations](../physics/Equations.md#self-absorption-and-curve-of-growth).
