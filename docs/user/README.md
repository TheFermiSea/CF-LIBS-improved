...
User-facing scientific documentation for CF-LIBS. Start here if you have
a LIBS spectrum and want results.
...
| [Hardware_Interfaces.md](Hardware_Interfaces.md) | Real-time DAQ, hardware interface, and streaming workflows. |
| [Echellogram_Processing_Guide.md](Echellogram_Processing_Guide.md) | Extracting 1D spectra from 2D echellogram images. |
