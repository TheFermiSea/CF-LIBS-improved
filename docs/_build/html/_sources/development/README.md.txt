...
The repository-root files `CLAUDE.md` and `AGENTS.md` describe how Claude
Code and other AI agents operate in this repo. They are not user
documentation and are not the canonical source for physics — that is
